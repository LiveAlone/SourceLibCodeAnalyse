 ...
 * under the License.
 */
package org.yqj.source.demo.basic.netty.example.portunification;
...
import org.yqj.source.demo.basic.netty.example.factorial.BigIntegerDecoder;
import org.yqj.source.demo.basic.netty.example.factorial.FactorialServer;
import org.yqj.source.demo.basic.netty.example.factorial.NumberEncoder;
import org.yqj.source.demo.basic.netty.example.http.snoop.HttpSnoopServerHandler;
...
public class PortUnificationServerHandler extends ByteToMessageDecoder {
    ...
    private void switchToFactorial(ChannelHandlerContext ctx) {
        ...
        p.addLast("handler", new FactorialServer.FactorialServerHandler());
        p.remove(this);
    }
}
